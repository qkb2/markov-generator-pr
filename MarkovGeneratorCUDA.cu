...
MarkovGeneratorCUDA::MarkovGeneratorCUDA(int max_ngram_len, std::string& path) : Generator(max_ngram_len, path) {}

std::vector<std::vector<std::string>> MarkovGeneratorCUDA::get_word_ngrams(std::string& data)
{
...
void MarkovGeneratorCUDA::generate_ngram_markov()
{
...
std::string MarkovGeneratorCUDA::generate_word_chain(std::string starter, int words_to_gen)
{
